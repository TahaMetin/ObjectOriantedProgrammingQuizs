public class Doktara extends LisansUstu{
    public Doktara(String adi, int gecmeNotu, int kredisi, int not1, int not2, int tezNotu) {
    ...
    public boolean OnurOgrencisiMi() {
        if(MezunOlmaHakkiVarMi() && OrtalamaHesapla()%25>3) return true;
        else return false;
    }
